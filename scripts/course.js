...
const filterButtons = [allBtn, wddBtn, cseBtn];
...
allBtn.addEventListener('click', () => { setActive(allBtn); displayCourses('All'); });
wddBtn.addEventListener('click', () => { setActive(wddBtn); displayCourses('WDD'); });
cseBtn.addEventListener('click', () => { setActive(cseBtn); displayCourses('CSE'); });
